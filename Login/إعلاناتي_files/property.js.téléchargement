...
function renderConverter(elementToWrite, amount, currencyFrom, currencyTo) {
    elementToWrite.append('<iframe src="/Home/_converterForm?' + amount + ':' + currencyFrom + ':' + currencyTo + '" width="260" height="70" scrolling="no" marginwidth="0" marginheight="0" frameborder="0" style="border: 3px solid #015D1D; position:relative; top:3px; text-align:center; background-color:#FFFFFF;"></iframe></center></div>');
}